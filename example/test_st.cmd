...
#       simulation on port 1 is fed back to port 0
#
...
TSTPORT = tyHYOctalDevCreate("/ty/enz/4", MODNUM, TSTPNUM, 2500, 250)

tyHYOctalConfig (ENZPORT, 9600, 'N', 1, 8, 'N')
tyHYOctalConfig (TSTPORT, 9600, 'N', 1, 8, 'N')
...
###########################################################
# Run the simulation on port 1
#
sp enzLoCuM4Simulate, "/ty/enz/4"
